...
class ControlsManager:
    ...
    def _generate_controls_items(self):
        ...
        controls_items = [
            ...
            {"type": "control", "text": f"{back_l} = Back to list / Exit (long press)"},
            {"type": "control", "text": f"{prev_l} = Volume down (when playing) / list up"},
            {"type": "control", "text": f"{next_l} = Volume up (when playing) / list down"},
            {"type": "control", "text": f"{select_l} = Play (from list) / Play-Pause (when playing)"},
            {"type": "spacer", "text": ""},
            ...
            {"type": "spacer", "text": ""},
            {"type": "section", "text": "SECRET MENU (keyboard):"},
            {"type": "control", "text": f"Hold {prev_l} + {next_l} for 2 sec (duration in Settings)"},
            {"type": "control", "text": "Joystick: long press Select on Settings item"},
            {"type": "spacer", "text": ""},
