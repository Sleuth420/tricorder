...
class ControlsManager:
    ...
    def _generate_controls_items(self):
        ...
        controls_items = [
            ...
            {"type": "control", "text": f"{back_l} = Exit (long press)"},
            {"type": "control", "text": f"{prev_l} = Previous track / move list up"},
            {"type": "control", "text": f"{next_l} = Next track / move list down"},
            {"type": "control", "text": f"{select_l} = Play / Pause (shows pause overlay)"},
            {"type": "control", "text": f"Long {next_l} = Volume up"},
            {"type": "control", "text": f"Double-tap {next_l} = Volume down"},
            {"type": "control", "text": f"Long {select_l} = Mute toggle"},
            {"type": "spacer", "text": ""},
