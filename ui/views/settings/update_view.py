...
def draw_update_view(screen, app_state, fonts, config_module):
    ...
    info_y += version_surface.get_height() + 3
    ...
    info_y += platform_surface.get_height() + 3
    ...
    if system_config and update_info['is_raspberry_pi']:
        ...
        if total_configs > 0:
            ...
            info_y += config_surface.get_height() + 8
    ...
    if update_info['last_check_result']:
        ...
        info_y += check_surface.get_height() + 15
    
    # Now draw the menu starting below the info section
    # We need to manually position the menu content area
    menu_start_y = info_y + 10
