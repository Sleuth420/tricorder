...
# ===== DEPRECATION WARNING =====
# This file (app_state_old.py) is DEPRECATED and should NOT be used!
# The monolithic AppState class has been refactored into modular components.
# Please use "from models.app_state import AppState" instead.
# 
# If you see this warning, it means some code is still importing this old file.
# Please update the import to use the new refactored architecture.
# ===============================

warnings.warn(
    "app_state_old.py is deprecated! Use AppState from models.app_state instead.",
    DeprecationWarning,
    stacklevel=2
)

logger = logging.getLogger(__name__)
logger.warning("DEPRECATED: app_state_old.py is being used! Please update imports to use AppState.")
...
class AppState:
    """DEPRECATED: Use AppState from models.app_state instead. This monolithic class has been broken down into focused components."""
    
    def __init__(self, config_module, screen_width, screen_height): # config_module is the actual config package module
        """
        DEPRECATED: Initialize the application state.
        Use AppState from models.app_state instead for the new modular architecture.
        """
        warnings.warn(
            "AppState class from app_state_old.py is deprecated! Use AppState from models.app_state instead.",
            DeprecationWarning,
            stacklevel=2
        )
